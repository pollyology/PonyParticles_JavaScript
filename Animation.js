...
export function changeCharacter(forward = true)
{
    // Loops forwards or backwards the character list
    characterIndex = (forward) ? (characterIndex + 1) % characterMap.length : (characterIndex - 1 + characterMap.length) % characterMap.length;    // Increments index by 1 and loops through array without going out-of-bounds
...
// ==============================================================================================================================================================================
//    +-------------------------------+
//    |        UPDATE SPRITE          |    // Quarantined because code is semi-functional, but not as intended. Ignoring for now.
//    +-------------------------------+
